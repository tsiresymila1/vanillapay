...
module.exports = function(site_url,client_id,client_secret,public_key,private_key){
    ...
    function send(url,params,callback,errorcallback) {
    ...
    function initPaie(idpanier,montant,nom,reference,adresseip,callback){
        var params = {
            "unitemonetaire": "Ar",
            "adresseip": adresseip,
    ...
    function resultPaie(crypedidpaiement,callback) {
